    ...
    function submitform()
         ...
         //   e.preventDefault();
            ...
            ajaxcall(method,url,data).then((data) => {
             ...
             if(data.page != "")
             {
                delete data.user.json
                delete data.user.designation
...
var width = 420; // We will scale the photo width to this
 ...
 $(".f1").on("click",function(){
    $("#imagetag").attr("src","./assets/img/IHM-56.png") ;
    $(".imgvideo").css("background-image",'url(' + "./assets/img/IHM-56.png" + ')') ;
    imageurl =  "./assets/img/IHM-56.png";
      $('.photob-btn').css("display","block");
    });

    $(".f2").on("click",function(){
    $("#imagetag").attr("src","./assets/img/IHM-52.png") 
    $(".imgvideo").css("background-image",'url(' + "./assets/img/IHM-52.png" + ')') ;
   imageurl =  "./assets/img/IHM-52.png";
     $('.photob-btn').css("display","block");
    });
    $(".f3").on("click",function(){
    $("#imagetag").attr("src","./assets/img/IHM-51.png") 
    $(".imgvideo").css("background-image",'url(' + "./assets/img/IHM-51.png" + ')') ;
    imageurl =  "./assets/img/IHM-51.png";
    $('.photob-btn').css("display","block");

    });
    $(".f4").on("click",function(){
    $("#imagetag").attr("src","./assets/img/IHM-53.png") 
    $(".imgvideo").css("background-image",'url(' + "./assets/img/IHM-53.png" + ')') ;
    imageurl =  "./assets/img/IHM-53.png";
      $('.photob-btn').css("display","block");
    });
    $(".f5").on("click",function(){
    $("#imagetag").attr("src","./assets/img/IHM-54.png") 
    $(".imgvideo").css("background-image",'url(' + "./assets/img/IHM-54.png" + ')') ;
    imageurl =  "./assets/img/IHM-54.png";
      $('.photob-btn').css("display","block");
    });


    $(".year-yes").click(function (e) {
             window.open('/IHM/assets/f1.pdf', '_blank');
            });
...
function appendfileupload()
{
    ...
    '</form><div style="display:none" class="loader"></div><style type="text/css">'+
    ...
    $.each(data,function(key,value){
        ...
        msg += '<article class="notify-article">'+
                            '<div class="not-msg">'+
                                ...
                                '<p>Please Download your myYearbook</p>'+
                            '</div>'+
                            '<div class="not-time">'+
...
// Calculates minutes until 8pm
  const
    ...
    eightPM = new Date();
  eightPM.setHours(0, 0, 0, 0); // Sets the new date object's time to 8pm
  const
  ...
  console.log(`Minutes until 8pm: ${minsDuration}`);
   if(window.location.href.indexOf("auditorium") > 11) // This doesn't work, any suggestions?
    {
     if(minsDuration<0 && minsDuration > -90) // This doesn't work, any suggestions?
    { 
      $(".menu2 > a").attr("href","#");
